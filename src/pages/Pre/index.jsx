					...
					<Card classe="my-64 px-24 py-32 flex flex-col gap-16">
						...
						<section className="w-full border border-neutral-100-10 rounded-md flex md2:flex-col">
							...
							<div className="p-24 flex w-full gap-24 md2:flex-col">
								...
								<section className="flex-1">
									<h3 className="title3 md2:text-center">
										Previsão de Geração
									</h3>
									<Charts
										options={options2}
							...
							<div className="md2:w-full">
								...
								<Button
									...
									<a
										href={
											isMobile
												? `whatsapp://send?text=Veja essa pré proposta do Mercado Solar%0https://mercado-solar.vercel.app/dados-de-orcamento/${budgetRequest?.id}/`
												: undefined
										}
										onClick={() => {
											if (!isMobile) {
										...
										<Badge
											...
											classe={
												budgetRequest.budget_request_status == 'Aprovada'
													...
													: budgetRequest.budget_request_status ===
													  'Em Progresso'
													? 'bg-alert-warning-10'
													: 'bg-alert-error-10'
											}
