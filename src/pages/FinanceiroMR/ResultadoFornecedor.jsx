...
const ResultadoFornecedor = () => {
    ...
    const data = [
        {
            hash: '01',
            fornecedor: 'Bruno Siqueira',
            saidas: "R$ 1000,00"
        },
        {
            hash: '02',
            fornecedor: 'Diana Lins',
            saidas: "R$ 1500,00"
        },
        {
            hash: '01',
    ...
    const handleDropdown = (e) => {
        ...
        if (offsetBottom < drop_container.current?.getBoundingClientRect().height + 60) {
            ...
            dropdown.classList.add('md:!top-[-380px]', '!top-[-360px]')
        } else {
            dropdown.classList.remove('md:!top-[-380px]', '!top-[-360px]')
    ...
    const HeaderFornecedor = ({ filter, setFilter, pageSize, setPageSize }) => {
        return (
            <div className="flex md:flex-col mr-40 gap-32 justify-between items-center md:w-full mb-24">
                ...
                <div className="flex md:flex-col md:!items-end md:w-full md:gap-16 gap-8 items-center">
                    <div className="flex gap-8 items-center md:w-full">
                        <Dropdowns classe="md:w-full">
                            ...
                            >
                                <Button
                                    ...
                                    iconID="#icon_config_filter" classe="secondary  w-full  !h-48 ">
                                    {/* bg-alert-red-100 */}
																		Filtrar
                                </Button>
                            </DropdownItem>
                            ...
                            <DropdownContainer classe="!max-w-[370px] md:left-0 md:!w-[85vw] md2:!w-[85vw] !w-[370px] !p-0 rounded-tr-md rounded-tl-md mt-4 shadow-sm border border-neutral-30">
                                <div ref={drop_container} className='flex flex-col gap-16 p-16 w-[370px] md:!w-[85vw] md2:!w-[85vw] max-w-[370px]'>
                                    <label
                        ...
                        <p className="text-primary-pure font-medium cursor-pointer mr-40 ml-16 md:mr-0 md:w-[150px]">Limpar filtro</p>
                    </div>
                    ...
                    <Title classe="text-neutral-90 gap-8 font-medium">
                        <div>
                            <div className='flex items-center gap-8'>
                                ...
                                <p className='block text-neutral-90 font-medium'>Resultado por Fornecedor</p>
                            </div>
                        </div>
                    </Title>
                </header>
