...
const LivroCaixa = () => {
    ...
    const dataUnidade = [
        {
            value: 'rio', label: 'Centro - Rio de Janeiro',
        },
        {
            value: 'botafogo', label: 'Botafogo'
        },
        {
            value: 'raca', label: 'Flamengo'
        }
    ]
            ...
            <Card classe="my-64 px-24 py-32">
                <header className='flex justify-between md2:flex-col md2:gap-16 mb-20'>
                    <Title classe="text-neutral-90 gap-8 font-medium">
                        <div>
                            <div className='flex items-center gap-8'>
                                ...
                                <p className='block text-neutral-90 font-medium'>Livro caixa-geral</p>
                            </div>
                        </div>
                    </Title>
                    ...
                    <div className="flex items-center gap-16">
                                    ...
                                    <div className='flex gap-16 '>
                                        ...
                                        >
                                            ...
                                            <InputDate
                                                ...
                                                classe="w-full" containerClass="w-[100%] z-[20] caixa-geral" startDate={startDate} setStartDate={setStartDate} placeholder="dd/mm/aaaa" />
                                        </div>
                                        ...
                                        >
                                            Até
                                            <InputDate classe="w-full" containerClass="w-[100%] z-[20] caixa-geral" startDate={startDate} setStartDate={setStartDate} placeholder="dd/mm/aaaa" />
                                        </div>
                                    </div>
                        ...
                        <p className='font-medium text-primary-pure cursor-pointer'>Limpar filtros</p>
                    </div>
                </header>
                ...
                <div className='flex gap-24 md2:flex-col overflow-hidden'>
                    ...
                    <div className='flex flex-col gap-8 w-[272px] md2:flex-row md2:w-full md:flex-col'>
                        <div className='md2:flex-1 h-max flex gap-16 relative border min-h-[130px] max-h-[130px] border-neutral-20 rounded-md shadow overflow-hidden'>
                            <div className='w-[50%] flex items-center'>
                                <div className='absolute px-24 bg-[#fff]'>
                                    <h1 className='tracking-wider text-alert-green font-bold mb-16'>RECEITAS</h1>
                            ...
                            <div className='!flex-[70%]'>
                                <Charts options={receitasOptions} series={series2} height={100} type="area" />
                            </div>
                        </div>
                        ...
                        <div className='md2:flex-1 h-max flex gap-16 relative border min-h-[130px] max-h-[130px] border-neutral-20 rounded-md shadow overflow-hidden'>
                            <div className='w-[50%] flex items-center'>
                                <div className='absolute px-24 bg-[#fff]'>
                                    <h1 className='tracking-wider text-alert-red-100 font-bold mb-16'>DESPESAS</h1>
                                    <p className='flex gap-8'>
                                        <span className='text-neutral-70 font-semibold'>R$</span>
                            ...
                            <div className='!flex-[70%]'>
                                <Charts options={despesasOptions} series={series2} height={100} type="area" />
                            </div>
                        </div>
                        ...
                        <div className='md2:flex-1 h-max flex gap-16 relative border min-h-[130px] max-h-[130px] border-neutral-20 rounded-md shadow overflow-hidden'>
                            <div className='w-[50%] flex items-center'>
                                <div className='absolute px-24 bg-[#fff]'>
                                    <h1 className='tracking-wider text-primary-pure font-bold mb-16'>SALDO</h1>
                                    <p className='flex gap-8'>
                                        <span className='text-neutral-70 font-semibold'>R$</span>
