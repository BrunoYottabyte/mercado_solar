	...
	return (
		<main className='w-screen h-screen grid place-items-center'>
			...
			<Card classe="p-24 max-w-[592px] w-[37rem] border border-neutral-100 md2:max-w-[90vw]">
				<h1 className='title2 mb-40 md2:text-2xl'>Sua pré proposta está sendo gerada. Crie uma senha para <br></br> visualizar seus orçamentos</h1>
				<Badge iconID="#icon-user-profile-ms" title={email} classe="py-8 pl-10 pr-24 mb-24 text-base bg-neutral-100-05 text-neutral-70 " />
