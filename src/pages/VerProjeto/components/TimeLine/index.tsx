...
const TimeLine = () => {
  ...
  const nextLevel = () => {
    nivel++;
    let offsetLeft = document.querySelector(`.point[nivel="${nivel}"]`).offsetLeft;
    document.querySelector('.progress_bar').style.width = `${offsetLeft + 2}px`
  }
    ...
    <Card classe="p-24 md2:mx-0">
      <div className="flex justify-between items-center md:flex-col md:!items-start">
        <div className="flex items-center gap-8 mb-32 md:mb-16">
          ...
          <h3 className="title3" onClick={nextLevel}>Status do pedido</h3>
        </div>
      ...
      <div className="timeline-horizontal-container md:!w-max md:!justify-between relative overflow-x-auto">
        <div className="progress_bar transition-all duration-700 absolute top-4 md:top-4 w-[0px] h-[6px] overflow-hidden rounded-md border border-neutral-100-10">
